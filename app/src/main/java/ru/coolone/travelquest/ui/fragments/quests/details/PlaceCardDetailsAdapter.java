...
public class PlaceCardDetailsAdapter extends RecyclerView.Adapter<PlaceCardDetailsAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            mail = v.findViewById(R.id.card_details_mail);
            rank = v.findViewById(R.id.card_details_rank);
     ...
     */
    static public class LinearLayoutManager extends android.support.v7.widget.LinearLayoutManager {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mail.setText(mItem.mail);
        ...
        holder.rank.setText("#".concat(Integer.toString(position + 1)));
